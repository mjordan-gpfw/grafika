 ...
 * </ol>
 */
public class TextureToRsActivity extends Activity implements SurfaceHolder.Callback,
    ...
    private static String mBigBuckBunny = "http://redirector.c.youtube.com/videoplayback?id=604ed5ce52eda7ee&itag=22&source=youtube&"
    ...
    private static class MainHandler extends Handler {
        ...
        private WeakReference<TextureToRsActivity> mWeakActivity;

        public MainHandler(TextureToRsActivity activity) {
            mWeakActivity = new WeakReference<TextureToRsActivity>(activity);
        }
        ...
        public void handleMessage(Message msg) {
            TextureToRsActivity activity = mWeakActivity.get();
            if (activity == null) {
